...
namespace SILDMS.Service.QuotationApproval
{
    public class QuotationApprovalService : IQuotationApprovalService
    {
        ...
        ValidationResult IQuotationApprovalService.AllSavcdClientQuotationRecommendationService(string UserId, int page, int itemsPerPage, string sortBy, bool reverse, string search, string type, string action, out List<OBS_ClientwithReqQoutn> AllAvailableClientsList)
        {
            AllAvailableClientsList = _quotationApprovalDataService.AllSavcdClientQuotationRecommendationDataService(UserId, page, itemsPerPage, sortBy, reverse, search, type, action, out _errorNumber);
        ...
        ValidationResult IQuotationApprovalService.GetClientReqDataInfoAprvService(string ClientID, string ClientReqID, out List<ClientReqData> GetClientReqDetails)
        {
            GetClientReqDetails = _quotationApprovalDataService.GetClientReqDataInfoAprvDataService(ClientID, ClientReqID, out _errorNumber);
