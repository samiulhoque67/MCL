...
namespace SILDMS.Service
{
    public class VendorRequisitionService : IVendorRequisitionService
    {
        ...
        public ValidationResult GetClientListForVendorRequisition(out List<OBS_ClientReq> VendorInfoList)
        {
            VendorInfoList = clientInfoDataService.GetClientListForVendorRequisition();
            return ValidationResult.Success;
        }
        ...
        public ValidationResult GetVendorWiseItemList(string ServiceCategoryID, out List<OBS_VendorInfo> VendorReqSearchList)
        {
            VendorReqSearchList = clientInfoDataService.GetVendorWiseItemList(ServiceCategoryID);
            return ValidationResult.Success;
        }
