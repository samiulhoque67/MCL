...
namespace SILDMS.Service.QuotationRecommendation
{
    public interface IQuotationRecommendationService
    {
        ...
        ValidationResult AllSavcdClientsQuotationService(string UserId, int page, int itemsPerPage, string sortBy, bool reverse, string search, string type, out List<OBS_ClientwithReqQoutn> AllAvailableClientsList);
        ValidationResult GetClientReqDataInfoService(string ClientID, string ClientReqID,string ClientQutnID, out List<ClientReqData> GetClientReqDetails);
