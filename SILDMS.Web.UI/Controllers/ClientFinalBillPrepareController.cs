...
{
    public class ClientFinalBillPrepareController : Controller
    {
        // GET: VendorFinalBillReceived
        readonly IClientFinalBillPrepareService _clientFinalBillPrepareService;
        ...
        public ClientFinalBillPrepareController(IClientFinalBillPrepareService clientFinalBillPrepareService, ILocalizationService localizationService)
        {
        ...
        public async Task<dynamic> SaveVendorFinalBill(VendorBillRecvd BillRecv)
        {
            ...
            status = _clientFinalBillPrepareService.SaveClientFinalBill(BillRecv);
