...
{
    public class ClientBillRcmdController : Controller
    {
        // GET: ClientBillRcmd

        readonly IClientBillRcmdService _clientBillRcmdService;
        ...
        public ClientBillRcmdController(IClientBillRcmdService clientBillRcmdService, ILocalizationService localizationService)
        {
            _clientBillRcmdService = clientBillRcmdService;
        ...
        public async Task<dynamic> GetShowVendorReqList()
        {
            ...
            await Task.Run(() => _clientBillRcmdService.GetShowClientReqList(out VendorReqList));
        ...
        public async Task<dynamic> SaveVendorFinalBill(VendorBillRecvd BillRecv)
        {
            ...
            status = _clientBillRcmdService.SaveClientFinalBill(BillRecv);
        ...
        public async Task<dynamic> GetQutnSearchList()
        {
            ...
            await Task.Run(() => _clientBillRcmdService.GetQutnSearchList(out PoSearchList));
