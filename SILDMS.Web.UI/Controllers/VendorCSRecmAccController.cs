...
{
    public class VendorCSRecmAccController : Controller
    {
        ...
        public VendorCSRecmAccController(IVendorCSAprvService repository, ILocalizationService localizationService)
        {
