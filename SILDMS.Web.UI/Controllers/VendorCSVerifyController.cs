...
{
    public class VendorCSVerifyController : Controller
    {
        // GET: VendorCSVerify
        ...
        public VendorCSVerifyController(IVendorCSAprvService repository, ILocalizationService localizationService)
        {
