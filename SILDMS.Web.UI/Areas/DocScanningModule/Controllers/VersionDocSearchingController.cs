...
namespace SILDMS.Web.UI.Areas.DocScanningModule.Controllers
{
    ...
    public class VersionDocSearchingController : Controller
    {
            ...
            string _DocTypeID, string _DocPropertyID, string _SearchBy)
        {
            ...
            var result = (from v in Versionresult
                ...
                select new
                {
                    ...
                    DocPropertyName = v.DocPropertyName
        ...
        //public async Task<dynamic> GetDocumentsByWildSearch(string _SearchFor)
        //{
        ...
        public async Task<dynamic> GetDocumentsByWildSearch(string _SearchFor)
        {
            ...
            if (!string.IsNullOrEmpty(_SearchFor))
            {
                await Task.Run(() => _originalDocSearchingService.GetDocumentsByWildSearch(
                    _SearchFor, UserID, out OriginalMeta));
            }
            ...
            if (!string.IsNullOrEmpty(_SearchFor))
            {
                await Task.Run(() => _versionDocSearchingService.GetDocumentsByWildSearch(
                    _SearchFor, UserID, out VersionMeta));
            }
            ...
            var result = (from v in Versionresult
                ...
                select new
                {
                    ...
                    VersionNo = v.VersionNo,
                    OwnerID = v.OwnerID,
                    DocCategoryID = v.DocCategoryID,
                    DocTypeID = v.DocTypeID,
                    DocPropertyID = v.DocPropertyID,
                    DocPropertyName = v.DocPropertyName
                }).DistinctBy(x => x.DocVersionID).ToList();
