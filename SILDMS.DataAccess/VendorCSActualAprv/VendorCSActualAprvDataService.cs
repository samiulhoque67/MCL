...
{
    public class VendorCSActualAprvDataService : IVendorCSActualAprvDataService
    {
        ...
        public string SaveVendorCSAprv(OBS_VendorCSAprv vendorCSInfo, List<OBS_VendorCSAprvItem> vendorCSInfoItem, List<OBS_VendorCSAprvTerms> vendorCSInfoTerm)
        {
            ...
            try
            {
                DatabaseProviderFactory factory = new DatabaseProviderFactory();
                SqlDatabase db = factory.CreateDefault() as SqlDatabase;
                using (DbCommand dbCommandWrapper = db.GetStoredProcCommand("OBS_SetVendorCSActualAprv"))
                {
                    // Set parameters 
        ...
        public string SaveVendorCSRecAcc(OBS_VendorCSAprv vendorCSInfo, List<OBS_VendorCSAprvItem> vendorCSInfoItem, List<OBS_VendorCSAprvTerms> vendorCSInfoTerm)
        {
        ...
        public string SaveVendorCSRecAudit(OBS_VendorCSAprv vendorCSInfo, List<OBS_VendorCSAprvItem> vendorCSInfoItem, List<OBS_VendorCSAprvTerms> vendorCSInfoTerm)
        {
        ...
        public List<Invitation> GetAllRequisition(string userID)
        {
            ...
            using (var dbCommandWrapper = db.GetStoredProcCommand("OBS_VendorReqForCSActualAprv"))
            {
                db.AddInParameter(dbCommandWrapper, "@UserId", SqlDbType.VarChar, userID);
        ...
        public List<Invitation> GetAllCSRecDataforAcc(string userID)
        {
            var invitationList = new List<Invitation>();

            var factory = new DatabaseProviderFactory();
            var db = factory.CreateDefault() as SqlDatabase;
            using (var dbCommandWrapper = db.GetStoredProcCommand("OBS_VendorReqForCSAccRec"))
            {
                db.AddInParameter(dbCommandWrapper, "@UserId", SqlDbType.VarChar, userID);
                //db.AddOutParameter(dbCommandWrapper, "@p_Error", DbType.Int32, 10);
                // Execute SP.
        ...
        public List<Invitation> GetAllCSRecDataforVerify(string userID)
        {
            var invitationList = new List<Invitation>();

            var factory = new DatabaseProviderFactory();
            var db = factory.CreateDefault() as SqlDatabase;
            using (var dbCommandWrapper = db.GetStoredProcCommand("OBS_VendorReqForCSRecAudit"))
            {
                db.AddInParameter(dbCommandWrapper, "@UserId", SqlDbType.VarChar, userID);
                var ds = db.ExecuteDataSet(dbCommandWrapper);
                if (ds.Tables[0].Rows.Count > 0)
        ...
        public List<Invitation> GetAllApprovedData(string userID)
        {
            var invitationList = new List<Invitation>();
            var factory = new DatabaseProviderFactory();
            var db = factory.CreateDefault() as SqlDatabase;
            using (var dbCommandWrapper = db.GetStoredProcCommand("OBS_GetAllApprovedData"))
            {
                db.AddInParameter(dbCommandWrapper, "@UserId", SqlDbType.VarChar, userID);
                var ds = db.ExecuteDataSet(dbCommandWrapper);
                if (ds.Tables[0].Rows.Count > 0)
        ...
        public List<OBS_VendorCSAprvItem> GetVendorByMaterialData(string vendorReqID, string serviceItemID)
        {
            ...
            DatabaseProviderFactory factory = new DatabaseProviderFactory();
            SqlDatabase db = factory.CreateDefault() as SqlDatabase;
            using (DbCommand dbCommandWrapper = db.GetStoredProcCommand("OBS_VendorDetailsForCSActualAprv"))
            {
        ...
        public List<Invitation> SearchCSData(string userID)
        {
            ...
            var factory = new DatabaseProviderFactory();
            var db = factory.CreateDefault() as SqlDatabase;
            using (var dbCommandWrapper = db.GetStoredProcCommand("OBS_SearchForCSAprv"))
            {
                db.AddInParameter(dbCommandWrapper, "@UserId", SqlDbType.VarChar, userID);
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    invitationList = dt1.AsEnumerable().Select(reader => new Invitation
                    {
                        ...
                        VendorCSNumber = reader.GetString("VendorCSActualAprvID"),
                        VendorRequisitionNumber = reader.GetString("VendorReqID"),
                        ServiceItemID = reader.GetString("ServiceItemID"),
                        ServiceItemName = reader.GetString("ServiceItemName"),
                        CSRecDate = reader.GetString("CSRecDate"),
        ...
        public List<OBS_VendorCSRecmItem> CSVendorData(string userID, string cSNumber)
        {
            ...
            var factory = new DatabaseProviderFactory();
            var db = factory.CreateDefault() as SqlDatabase;
            using (var dbCommandWrapper = db.GetStoredProcCommand("OBS_CSVendorAprv"))
            {
                db.AddInParameter(dbCommandWrapper, "@UserId", SqlDbType.VarChar, userID);
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    CSVendorList = dt1.AsEnumerable().Select(reader => new OBS_VendorCSRecmItem
                    {
                        ...
                        VendorQutnID = reader.GetString("VendorQutnID"),
                        VendorCSInfoID = reader.GetString("VendorCSActualAprvID"),
                        VendorName = reader.GetString("VendorName"),
        ...
        public List<OBS_VendorCSRecmTerms> CSVendorTerms(string cSNumber)
        {
            ...
            DatabaseProviderFactory factory = new DatabaseProviderFactory();
            SqlDatabase db = factory.CreateDefault() as SqlDatabase;
            using (DbCommand dbCommandWrapper = db.GetStoredProcCommand("OBS_GetVendorCSTermListAprv"))
            {
